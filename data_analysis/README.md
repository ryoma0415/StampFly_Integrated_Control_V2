...
| `plot_explog.py` | Experiment 計測ログのグラフ化(図6枚+summary.txt)+アニメ MP4(スマホ動画同期可) | `../pc_server/data/exp_logs/explog_*.csv`(+`exp_logs/videos/*.mp4`) | `graphs/explog_<stamp>/` |
